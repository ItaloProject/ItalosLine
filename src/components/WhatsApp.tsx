...
export default function WhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] transition-transform duration-300 hover:scale-110 active:scale-95"
    >
      {/* pulso de atenção */}
      <span
        aria-hidden
